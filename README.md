...
This is a folder for the first Mwai Kibaki HMS Prototypes
### Technologies used: C# JS,HTML $ CSS
...
"Total TEWS" Score is also automated according to the recorded value.
